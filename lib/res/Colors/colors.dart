...
class AppColors {
  ...
  static const Color primaryColorOrange =   Color(0xffc1460a);
  static const Color primaryColorOrangeTwo =   Color(0xfff69c6e);
  static const Color secondaryColor =  Color(0xffbcbfd1);

  static const Color ShowAllTextColor =  Color(0xffb53f05);
